...
def get_google_sheets_credentials():
    creds_file_path = 'C:/Users/yngrid.figlioli/Desktop/AAEE/IOM/my_flask_app/global-ace-417010-a45b5fe90edc.json'
...
def search_keywords(dataframe, country, creds):
    ...
    if country not in country_language_mapping:
        st.error(f"The country code '{country}' is not recognized.")
        return dataframe, []

    language_code = country_language_mapping[country]
